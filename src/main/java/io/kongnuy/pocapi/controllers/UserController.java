...
public class UserController {
  ...
  @PostMapping(path = "/{uuid_or_external_uuid}", produces = MediaType.APPLICATION_JSON_VALUE)
  @Operation(summary = "Update the user by uuid or external uuid.", description = "Whether you are a LazzyConnect Admin or a Company,"
      + "this endpoint can help get the current registered user within your organization.<br/> "
      + "When calling this API endpoint, you can fill in the following parameters : <br/><ul>"
      + "<li><b> limit : </b>The maximun number of elements you want to retrieve,<br/></li>"
      + "<li><b> page : </b>This represents the offset. From where do you want to start,<br/></li>"
  ...
  public GenericApiResponse<?> update(@PathVariable(name = "uuid_or_external_uuid") String uuidOrExternalUuid, @Valid @RequestBody UserUpdateIn userUpdateIn) {
